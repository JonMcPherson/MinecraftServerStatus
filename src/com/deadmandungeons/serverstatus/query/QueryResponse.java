...
public class QueryResponse extends MinecraftServer {
	...
	public String toString() {
		return new StringBuilder("QueryResponse{address=").append(getAddress()).append(", players=").append(getPlayers()).append(", version=")
				.append(getVersion()).append(", description=").append(getDescription()).append(", mapName=").append(getMapName())
				.append(", serverType=").append(getServerType()).append(", plugins=").append(getPlugins()).append(", favicon=").append(getFavicon())
				.append("}").toString();
	}
